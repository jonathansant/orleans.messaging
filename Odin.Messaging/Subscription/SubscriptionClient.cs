...
{
	public async Task<string> Subscribe<TMessage>(OdinMessageSubscriptionInput<TMessage> input)
	{
...
public class SubscriptionBuilder<TMessage>
{
	...
	private static readonly Type DelegateType = typeof(Func<ImmutableList<OdinMessage<TMessage>>, Task>);
	...
	public SubscriptionBuilder<TMessage> WithGrainAction(Func<ImmutableList<OdinMessage<TMessage>>, Task> method)
	{
		_method = method;
		return this;
	}
	...
	public OdinMessageSubscriptionInput<TMessage> Build()
	{
		...
		var input = new OdinMessageSubscriptionInput<TMessage>
		{
...
/// <param name="ServiceKey">e.g. Bifrost, External (<see cref="OdinMessageBrokerNames"/>)</param>
...
[GenerateSerializer]
public record OdinMessageSubscriptionInput<TMessage>
{
	[Id(0)]
	...
	[Id(7)]
	public string ServiceKey { get; set; } = OdinMessageBrokerNames.Default;
}
