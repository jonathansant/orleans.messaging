...
public interface ISubscriptionGrain : IGrainWithStringKey
{
	...
	Task Push(ImmutableList<OdinMessage> batch);
...
public class SubscriptionGrain<TMessage> : Grain, ISubscriptionGrain<TMessage>
{
	...
	public async Task PushOneWay(ImmutableList<OdinMessage> batch)
		=> await Push(batch);

	public async Task Push(ImmutableList<OdinMessage> batch)
	{
